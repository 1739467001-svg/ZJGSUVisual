...
- 阶段 3 ✅ 3D 世界接入（R3F 沙盘：24h 昼夜循环、发光路网、状态光带、窗带自发光、CameraDirector 运镜、点选联动）
- 阶段 4 ✅ Wow 效果 + 四级联动（扫描命中 / 三级下钻+面包屑 / 异常脉冲 / 热力爆发 / 金色路径跟拍 / Bloom 后期 / 人流粒子）
- 阶段 5 ✅ 模拟引擎 + 管理态势（课表潮汐/能耗/人流模型、snapshot 单一数据源、ECharts 三图、下课潮汐粒子）
- 阶段 6 ⬜ 路演打磨
